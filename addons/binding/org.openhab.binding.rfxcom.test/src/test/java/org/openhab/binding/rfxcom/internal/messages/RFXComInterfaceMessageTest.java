...
import static org.openhab.binding.rfxcom.internal.messages.RFXComInterfaceMessage.Commands.GET_STATUS;
import static org.openhab.binding.rfxcom.internal.messages.RFXComInterfaceMessage.Commands.RESET;
import static org.openhab.binding.rfxcom.internal.messages.RFXComInterfaceMessage.SubType.RESPONSE;
import static org.openhab.binding.rfxcom.internal.messages.RFXComInterfaceMessage.SubType.START_RECEIVER;
import static org.openhab.binding.rfxcom.internal.messages.RFXComInterfaceMessage.SubType.UNKNOWN_COMMAND;
...
public class RFXComInterfaceMessageTest {
    private RFXComInterfaceMessage testMessage(String hexMsg, SubType subType, int seqNbr, Commands command, boolean skipDecode) throws RFXComException {
    ...
    public void testWelcomeCopyRightMessage() throws RFXComException {
        RFXComInterfaceMessage msg = testMessage("1401070307436F7079726967687420524658434F4D", START_RECEIVER, 3, Commands.START_RECEIVER, true);
