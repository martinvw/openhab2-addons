...
import static org.openhab.binding.rfxcom.internal.messages.RFXComSecurity1Message.SubType.RM174RF;
import static org.openhab.binding.rfxcom.internal.messages.RFXComSecurity1Message.SubType.X10_SECURITY;
...
public class RFXComSecurity1MessageTest {
    private void testSomeMessages(String hexMessage, RFXComSecurity1Message.SubType subType, int sequenceNumber, String deviceId, int batteryLevel, Contact contact, Motion motion, Status status, int signalLevel) throws RFXComException {
    ...
    public void testX10SecurityMessage() throws RFXComException {
        testSomeMessages("0820004DD3DC540089", X10_SECURITY, 77, "13884500", 8, Contact.NORMAL, Motion.UNKNOWN, Status.NORMAL, 9);
    }

    @Test
    public void testRM174RFSecurityMessage() throws RFXComException {
        testSomeMessages("08200A0E8000200650", RM174RF, 14, "8388640",  5, Contact.UNKNOWN, Motion.UNKNOWN, Status.PANIC, 0);
        testSomeMessages("08200A081450450650", RM174RF, 8, "1331269",  5, Contact.UNKNOWN, Motion.UNKNOWN, Status.PANIC, 0);
    }
