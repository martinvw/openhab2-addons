...
import org.openhab.binding.homeduino.internal.config.RFXComDeviceConfiguration;
...
public class RFXComHandler extends BaseThingHandler implements DeviceMessageListener {
        ...
        if (bridgeHandler != null) {
            ...
            if (command instanceof RefreshType) {
                ...
                try {
                    ...
                    RFXComHomeduinoMessage msg = RFXComMessageFactory.createMessage(packetType);
    ...
    protected HomeduinoBridgeHandler getBridgeHandler() {
