...
import static org.openhab.binding.rfxcom.RFXComValueSelector.BATTERY_LEVEL;
import static org.openhab.binding.rfxcom.RFXComValueSelector.RAIN_TOTAL;
...
public class RFXComTemperatureRainMessage extends RFXComBaseMessage {
    ...
    public void encodeMessage(byte[] data) throws RFXComException {
        ...
        temperature = (double) ((data[6] & 0x7F) << 8 | (data[7] & 0xFF)) * 0.1;
        if ((data[6] & 0x80) != 0) {
            temperature = -temperature;
        }
        rainTotal = (double) ((data[8] & 0xFF) << 8 | (data[9] & 0xFF)) * 0.1;
